<template>
  <div id="DashBoard">
    <el-drawer :visible.sync="drawer" :with-header="false">
      <drawer @updateMenu="updateMenu"></drawer>
    </el-drawer>
  ...
  computed: {
    cuisines() {
      ...
      for (let i = 0; i < menu.length; i++) {
        var sen = menu[i].name + menu[i].descr + menu[i].price;
        if (sen.includes(this.search)) {
          arr.push(menu[i]);
        }
      }
      return arr;
